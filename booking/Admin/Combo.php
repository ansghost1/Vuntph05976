                ...
                <div class="card direct-chat direct-chat-primary">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div>
                                <a href="AddCombo.php"><button>THÊM COMBO</button></a>
                                <table border="1">
                                    <tr>
                                        <td>STT</td>
                                        <td>Tên Combo</td>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="EditCombo.php?id=<?php echo $row['id'] ?>"><input type="submit" value="sua"></a></td>
                                            <td><a href="DeleteCombo.php?maxoa=<?php echo $row['id'] ?>"><input type="submit" value="Xóa" name="btn_xoa"></a></td>
                                        </tr>
                                    <?php    }
                                    ?>
                                </table>
