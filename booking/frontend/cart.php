                        ...
                        <nav class="navbar navbar-default">
                            ...
                            <div class="navbar-header">
                                ...
                                <div class="site_logo fix">
                                    <a id="brand" class="clearfix navbar-brand border-right-whitesmoke" href="index.html"><img src="img/123361424_3863937486974199_7874159755537882930_n.jpg" alt="Trips" style="width: 70px; height: 70px;"></a>
                            ...
                            <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="contact-us.php">Liên lạc</a></li>
                                </ul>
                                    ...
                                    <div class="hotel_booking margin-top-70 margin-bottom-125">
                                        <form role="form" action="#" class="">
                                            <div class="row">
                                                <div class="form-group col-lg-4 col-md-4 col-sm-4 icon_arrow">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" placeholder="Họ ">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4 col-md-4 col-sm-4 icon_arrow">
                                                    <div class="input-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-3 col-md-3 col-sm-3 icon_arrow">
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" placeholder="Số điện thoại">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="container">
                                                    <div class="payment_system clearfix">
                                                        ...
                                                        <div class="right_pay_now floatright">
                                                            <a href="#" class="btn btn-warning btn-sm btn-success">Đặt lịch</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
