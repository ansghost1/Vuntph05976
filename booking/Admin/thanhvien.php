                ...
                <div class="card direct-chat direct-chat-primary">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div>
                                <a href="addthanhvien.php"><button>THÊM</button></a>
                                <table border="1">
                                    <tr>
                                        <td>STT</td>
                                        <td>Tên</td>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="editthanhvien.php?id=<?php echo $row['id'] ?>"><input type="submit" value="sua"></a></td>
                                            <td><a href="deletethanhvien.php?maxoa=<?php echo $row['id'] ?>"><input type="submit" value="Xóa" name="btn_xoa"></a></td>
                                        </tr>
                                    <?php    }
                                    ?>
                                </table>
