                    ...
                    <div>
                        ...
                        <div>
                            <form action="" method="POST" enctype="multipart/form-data">
                                <p>Tiêu đề</p><input type="text" name="tieude">
                                <p>Ảnh</p><input type="file" name="image">

                                <p>Nội dung</p><textarea id="w3review" name="noidung" rows="10" cols="50"></textarea><br>
                                <p>Môt tả</p><input type="text" name="mota"><br>
                                <p>Thời gian</p><input type="date" name="time"><br>
                                <p>Tác giả</p><input type="text" name="tacgia"><br>
                            ...
                            if (isset($_POST['btn'])) {
                                ...
                                $sql = "insert into tintuc value('null','$tieude','$name_image','$noidung','$mota','$time','$tacgia')";
                                echo $sql;
                                $kq = $conn->exec($sql);
                                if ($kq == 1) {
