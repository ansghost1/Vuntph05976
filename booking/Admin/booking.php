                ...
                <div class="card direct-chat direct-chat-primary">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div>
                                <a href="addbooking.php"><button>THÊM </button></a>
                                <table border="1">
                                    <tr>
                                        <td>STT</td>
                                        <td>Tên Combo</td>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="deletebooking.php?maxoa=<?php echo $row['id'] ?>"><input type="submit" value="Xóa" name="btn_xoa"></a></td>
                                        </tr>
                                    <?php    }
                                    ?>
                                </table>
