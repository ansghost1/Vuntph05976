                        ...
                        <nav class="navbar navbar-default">
                            ...
                            <div class="navbar-header">
                                ...
                                <div class="site_logo fix">
                                    <a href="index.php"><img src="img/123361424_3863937486974199_7874159755537882930_n.jpg" alt="Trips" style="width: 90px; height: 90px;"></a>
                            ...
                            <div class="margin-bottom-30 col-md-4 col-sm-6 col-xs-12">
                                <div class="single_blog_style1">
                                    ...
                                    <div class="blog_text_box">
                                        <h5>Lý do khiến lăn kim bằng máy tốt hơn lăn kim bằng tay</h5>
                                        <ul class="clearfix">
                                            <li><a href="#">By Admin |</a></li>
                                            <li><a href="#">3 Jan 2015 |</a></li>

                                        </ul>
                                        <p>Lăn kim bằng máy (phi kim) và lăn kim bằng tay đều sử dụng cơ chế tạo ra các vết thương giả trên da bằngRead More. </p>
                                        <a href="single-blog.php">Đọc Thêm</a>
                                    </div>
                                </div>
                            </div>
                            <div class="margin-bottom-30 col-md-4 col-sm-6 col-xs-12">
                            ...
                            <div class="margin-bottom-30 col-md-4 col-sm-6 col-xs-12">
                                <div class="single_blog_style2">
                                    ...
                                    <div class="blog_text_box">
                                        ...
                                        <a href="single-blog.html">Đọc Thêm</a>
                                    </div>
                                </div>
                            </div>
                            <div class="margin-bottom-30 col-md-4 col-sm-6 col-xs-12">
