                ...
                <div class="card direct-chat direct-chat-primary">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div>
                                <a href="addnhanvien.php"><button>THÊM</button></a>
                                <table border="1">
                                    <tr>
                                        <td>STT</td>
                                        <td>Tên nhân viên</td>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="editnhanvien.php?id=<?php echo $row['id_nv'] ?>"><input type="submit" value="sua"></a></td>
                                            <td><a href="deletenhanvien.php?maxoa=<?php echo $row['id_nv'] ?>"><input type="submit" value="Xóa" name="btn_xoa"></a></td>
                                        </tr>
                                    <?php    }
                                    ?>
                                </table>
