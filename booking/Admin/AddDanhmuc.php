                    ...
                    <div>
                        ...
                        <div>
                            <form action="" method="POST" enctype="multipart/form-data">
                                <p>Tiêu đề</p><input type="text" name="name_dm">
                                <p>Ảnh </p><input type="file" name="image">

                                <p>Chi tiết</p><input type="text" name="noidung_dm"><br>
                            ...
                            if (isset($_POST['btn'])) {
                                ...
                                $sql = "insert into danhmuc value('null','$name_dm','$name_image','$noidung_dm')";
                                echo $sql;
                                $kq = $conn->exec($sql);
                                if ($kq == 1) {
