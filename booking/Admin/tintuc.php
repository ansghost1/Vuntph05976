                ...
                <div class="card direct-chat direct-chat-primary">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div>
                                <a href="addtintuc.php"><button>THÊM</button></a>
                                <table border="1">
                                    <tr>
                                        <td>STT</td>
                                        <td>Tiêu đề</td>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="edittintuc.php?id=<?php echo $row['id'] ?>"><input type="submit" value="sua"></a></td>
                                            <td><a href="deletetintuc.php?maxoa=<?php echo $row['id'] ?>"><input type="submit" value="Xóa" name="btn_xoa"></a></td>
                                        </tr>
                                    <?php    }
                                    ?>
                                </table>
